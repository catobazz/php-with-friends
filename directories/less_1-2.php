...
echo "<h4> Ниже будут выведены результаты домашки </h4>";
...
$dirtyPhoneNumbers = [
    'тут телефонный номер Грязного Гарри',
    'тут телефонный номер Грязного Васи',
    'тут телефонный номер Веры после 16 часовой смены',
];

// Вывод значений массивов на экран
echo "<br> Массив букв: <br>";
print_r($letters);
echo "<br><br>";
...
if ($a * $b < $c + $d) {
    echo " Произведение a, b меньше суммы c, d <br>";
} else {
    echo " Произведение a, b больше суммы c, d <br>";
}
...
if ($a - $b > $c / $d) {
    echo "<br> Разность a, b больше частности c на d";
} else {
    echo "<br> Разность a, b меньше частности c на d";
}
echo "<br>";
...
echo " <br> Оператор == сравнивает значения, но не типы, в то время как оператор === сравнивает значения и типы.
Рекомендуется использовать оператор === для более надежного сравнения."
